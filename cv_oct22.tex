...
\item[] B.S. with distinction, Physics, 1998
        ...
        \item Advisor: James Heasley under a Hawai`i Space Grant Fellowship
        \end{innerlist}
\end{outerlist}
...
\begin{innerlist}
    ...
    \begin{innerlist}
      ...
      \item Lead of Software and Algorithms Lab, OVRO
...
\begin{bibsection}
    ...
    \item Reviewer for SARAO (MeerKAT), NCRA (GMRT), FAST, NRAO, NASA and NSF, 2013 -- present
    ...
    \item Judge, AAS Chambliss poster competition, 2020 -- 2022
...
\item[] \textit{Student Advising}
  \hfill \textbf{2019 -- 2021}
    \begin{innerlist}
      ...
      \item Undergraduates \textbf{Carlos Ayala}, \textbf{Tyrone McNichols}, \textbf{Jerome (Johnny) Seebeck}, \textbf{Evan Seebeck}, \textbf{Rey Squillace} \\
