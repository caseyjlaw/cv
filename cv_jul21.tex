...
\emph{Astrophysical transients}, fast radio bursts, radio interferometry, surveys, algorithms and computing, data science, Python
...
\begin{innerlist}
    ...
    \begin{innerlist}
      ...
      \item Leader of Calibration, Imaging, and Software Lab
      \item Radio transients
      \item Commissioning of the Owens Valley Long-Wavelength Array and Deep Synoptic Array 110
    \end{innerlist}
...
\item[] \textit{Student Advising}
  \hfill \textbf{2019 -- 2021}
    \begin{innerlist}
      \item Graduate student mentorship (thesis committee): \textbf{Kshitij Aggarwal} (West Virginia University)
      ...
      \item Mentored undergraduates \textbf{Carlos Ayala}, \textbf{Tyrone McNichols}, \textbf{Jerome (Johnny) Seebeck}
