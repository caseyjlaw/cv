...
\emph{Radio interferometry}, astrophysical transients, distributed computing, fast radio bursts, surveys, intergalactic and interstellar media, data science, Python, polarimetry
...
\textbf{Jansky Very Large Array}
\begin{innerlist}
    \item Resident Observer, 2012.
    \item Led commissioning of fast dump interferometry.
\end{innerlist}
\textbf{Allen Telescope Array}
\begin{innerlist}
    \item Co-led development of fast correlator ("PoCo").
    \item Commissioned wide-field, wide-band polarimetric observations.
\end{innerlist}
\textbf{Karoo Array Telescope}
\begin{innerlist}
    \item Official visitor, 2011.
    \item Commissioned polarimetric and fast correlator observations with MeerKAT prototype array.
\end{innerlist}
\textbf{LOFAR}
\begin{innerlist}
    \item Member of LOFAR "builder's list", 2007.
    \item Helped commission prototype LOFAR station, Core Station 1.
    \item Developed transient key science project software.
\end{innerlist}
