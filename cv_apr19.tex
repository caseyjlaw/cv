...
\emph{Astrophysical transients}, radio interferometry, fast radio bursts, surveys, algorithms and computing, data science, Python
...
\begin{bibsection}
    ...
    \item Reviewer for NRAO, NASA and NSF, 2013 -- present
